...
// Enter array
void funcFor(int arr[], int start, int end, int step = 1) {
...
// Print revers array
void printReversFor(int arr[], int start, int end, int step = 1) {
...
// Sum array
int sumArray(int arr[], int start, int count) {
...
int fibonacci(int n, int x = 1, int y = 1) {
	if (n == 0) return y;
